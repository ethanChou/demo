...
namespace VisitorManager.App.Content
{
    /// <summary>
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/VisitorManager.App;component/Assets/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "love", Source = new Uri("/VisitorManager.App;component/Assets/ModernUI.Love.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "snowflakes", Source = new Uri("/VisitorManager.App;component/Assets/ModernUI.Snowflakes.xaml", UriKind.Relative) });
