        ...
        public bool SetupSurface(int videoWidth, int videoHeight, FrameFormat format)
        {
            ...
            switch (format)
            {
                ...
                case FrameFormat.RGB16: // rgb565
                    ...
                    break;
                case FrameFormat.RGB24: // rgb24
                    this.frameSize = this.width * this.height * 3; // 每个像素2字节
                    break;
            ...
            this.imageSource = new WriteableBitmap(videoWidth, videoHeight, DPI_X, DPI_Y, System.Windows.Media.PixelFormats.Bgr24, null);
            ...
            this.converter = new ConverterResizer(size, pixelType, size, PixelAlignmentType.RGB24);
