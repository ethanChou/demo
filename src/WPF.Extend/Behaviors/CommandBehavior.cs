...
namespace WPF.Extend.Behaviors
{
    /// <summary>
    /// Defines the attached properties to create a CommandBehaviorBinding
    /// View layer can use this properties of this class to binding data or command
    /// It contains Command,Action,CommandParameter,Event Attached properties
    /// </summary>
